...
//             {/* Subheading */}
//             <p className="text-lg sm:text-md text-gray-300 max-w-xl text-justify">
...
//               {/* <a
//                 href="#explore"
//                 className="px-8 py-4 rounded-xl bg-[#00ff87] text-[#030805]  text-sm tracking-wide transition-all duration-300 hover:bg-[#33ff9f] hover:shadow-[0_0_25px_rgba(0,255,135,0.4)] hover:-translate-y-0.5"
//               >
//                 Launch Platform
//               </a> */}
...
//              hover:shadow-[0_0_40px_rgba(0,255,102,0.55)]"
//               >
//                 {/* Neon Green Gradient */}
//                 <span
//                   className="absolute inset-0
//                bg-gradient-to-r from-[#00FF66] via-[#2BFF88] to-[#00CC52]
//                transition-all duration-500
//                shadow-[0_0_25px_rgba(0,255,102,0.4)]
//                group-hover:shadow-[0_0_40px_rgba(0,255,102,0.7)]"
//                 />
...
//               {/* <a
//                 href="#documentation"
//                 className="px-8 py-4 rounded-xl bg-white/5 border border-white/15 text-white  text-sm tracking-wide backdrop-blur-md transition-all duration-300 hover:bg-white/10 hover:border-white/30 hover:-translate-y-0.5"
//               >
...
//              transition-all duration-300
//              hover:-translate-y-0.5
//              hover:shadow-[0_0_30px_rgba(0,255,102,0.18)]"
//               >
...
//                group-hover:shadow-[0_0_25px_rgba(0,255,102,0.45)]"
//                 >
...
//                 <p className="text-2xl  text-[#00ff87]">60 FPS</p>
//                 <p className="text-xs text-gray-400">WebGL Optimized</p>
//               </div>
//               <div className='text-center'>
//                 <p className="text-2xl  text-white">0.02ms</p>
//                 <p className="text-xs text-gray-400">Latency Core</p>
//               </div>
//               <div className='text-center'>
//                 <p className="text-2xl text-[#00ff87]">100%</p>
//                 <p className="text-xs text-gray-400">CAD Interactive</p>
//               </div>
//             </div> */}


//             <div className="grid grid-cols-3 gap-6 pt-6 w-full max-w-lg border-t border-[#00FF66]/15">
...
//                  transition-all duration-300
//                  group-hover:drop-shadow-[0_0_12px_rgba(0,255,102,0.5)]"
//                 >
//                   60 FPS
//                 </p>
...
//                  transition-all duration-300
//                  group-hover:text-[#2BFF88]
//                  group-hover:drop-shadow-[0_0_12px_rgba(0,255,102,0.4)]"
//                 >
//                   0.02ms
//                 </p>
...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-screen bg-[#030805] text-white flex items-center overflow-hidden">
      ...
      {/* 3D Scene Background (Mouse Interaction Enabled) */}
      <Hero3DScene />

      {/* Hero Content Container (pointer-events-none দেওয়া হয়েছে যেন খালি জায়গায় মাউস ড্র্যাগ করলে পেছনের 3D ঘুরে) */}
      <div className="relative z-10 max-w-[1600px] mx-auto px-6 sm:px-8 lg:px-12 w-full py-20 lg:py-0 pointer-events-none">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
