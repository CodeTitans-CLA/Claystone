...
export default function Preloader({ onComplete }: PreloaderProps) {
  ...
  return (
    <div
      className={`fixed inset-0 z-[99999] bg-[#050706] ${
        isExiting
      ...
      <div className="relative flex h-full w-full flex-col justify-between p-6 sm:p-8 lg:p-10">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-[9px] font-bold tracking-[0.22em] text-white">
              CLAYSTONE
            </span>
          </div>
          ...
          <div className="mb-8 flex items-end justify-between">
            <div>
              ...
              <h1 className="mt-4 text-[clamp(42px,7vw,96px)] font-semibold leading-[0.9] tracking-[-0.05em] text-white">
                CLAYSTON
                <br />
                <span className="text-[#00ff87]">is loading..</span>
              </h1>
            </div>
